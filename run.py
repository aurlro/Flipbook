"""Point d'entrée de l'application Flask avec configuration sécurisée."""
...
def setup_logging():
    ...
    file_handler = RotatingFileHandler(
        log_file, maxBytes=10485760, backupCount=5, mode="a", encoding="utf-8"
    )
...
def verify_app_startup(app):
    ...
    try:
        with app.app_context():
            ...
            from app.services import HTMLGenerator, PDFProcessor
